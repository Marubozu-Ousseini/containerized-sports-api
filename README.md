...
```bash
git clone https://github.com/Marubozu-Ousseini/containerized-sports-api.git
...
```bash
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 465927846672.dkr.ecr.us-east-1.amazonaws.com

docker build --platform linux/amd64 -t sports-api .
docker tag sports-api:latest 465927846672.dkr.ecr.us-east-1.amazonaws.com/sports-api:sports-api-latest
docker push 465927846672.dkr.ecr.us-east-1.amazonaws.com/sports-api:sports-api-latest
```
